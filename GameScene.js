// Add of a 'score' variable to keep count of Bob's earnings
let score = 0;

// Add a 'moneyMultiplier' variable to multiply money
let moneyMultiplier = 100;

// Add a 'score' variable to control speed of Bob sprite
let speed = 0.5;
...
class GameScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.physics.add.overlap(gameState.player, gameState.money, () => {
      ...
      //Increase speed when Bob collides with the money sprite.
      speed += 0.1;
  ...
  update() {
    ...
    // Add of variables that store if a specific arrow key is being pressed
    ...
    // Check whether any of the arrow keys were pressed. If so, move Bob.
    if(rightArrow){
      moveBobRight();
    }else if(leftArrow){
      moveBobLeft();
    ...
    // Check collision between Bob and edges of the canvas of the game. If so, game over.
